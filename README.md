...
This repository showcases a highly available, and scalable AWS architecture for hosting a web application using AWS best practices. The design separates public and private resources, and enables controlled internet access for private workloads.
